...
const SCRIPT_PATH = path.resolve(__dirname, '../../scripts/provision-production.sh');
...
describe('provision-production.sh syntax validation', () => {
  ...
  it('R-P2-09: production provisioning enables automated backups', () => {
    const hasBackup = scriptContent.includes('--backup') || scriptContent.includes('enable-bin-log');
  ...
  it('script targets correct GCP project ID (gen-lang-client-0535844903)', () => {
