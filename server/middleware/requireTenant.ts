 ...
 * user's tenantId matches the requested companyId. Admin users are exempt.
 *
...
export function requireTenant(
    ...
    if (!authReq.user) {
        return next(
            new ForbiddenError('Tenant verification requires authentication.', {}, 'TENANT_NO_AUTH_001'),
        );
    }
