# Tests R-W4-02b, R-W4-05b, R-W4-VPC-507
"""H-507: Icon Button Accessibility + Heading Hierarchy — Batch 2.

Validates that all icon-only buttons in the 18 batch-2 components have
...
# -- R-W4-02b: Icon-only buttons must have aria-label --
...
def test_icon_buttons_have_aria_label(component: str):
    """R-W4-02b: All icon-only buttons must have descriptive aria-label."""
...
# -- R-W4-05b: Heading hierarchy must be sequential --
...
def test_heading_hierarchy_sequential(component: str):
    """R-W4-05b: Headings must follow sequential order with no skipped levels."""
    content = _read(component)
...
# -- R-W4-VPC-507: TypeScript compiles clean --


def test_vpc_tsc_clean():
    """R-W4-VPC-507: TypeScript compiles without errors for modified components."""
    import subprocess
