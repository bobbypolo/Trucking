            ...
            <div className="bg-[#020617] border border-white/10 w-full max-w-md rounded-3xl p-8 shadow-2xl space-y-6">
              ...
              <div className="flex gap-4 pt-2">
                <button
                  ...
                  className="flex-1 py-3 bg-white/5 text-white border border-white/10 rounded-2xl text-[11px] font-black uppercase tracking-widest"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 py-3 bg-emerald-600 text-white rounded-2xl text-[11px] font-black uppercase tracking-widest disabled:opacity-60"
                >
