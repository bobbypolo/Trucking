            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                    ...
                    },
                    {
                      ...
                      count:
                        incidents.filter((i) => i.severity === "Critical")
                          .length +
                        safeWorkItems.filter((w) => w.priority === "Critical")
                          .length,
                    },
                    {
                      id: "High",
              ...
              <div className="flex-1 overflow-y-auto no-scrollbar p-6 space-y-4">
                ...
                {(
                  ...
                  .filter((item) => {
                    const label = item.category === "TASK" ? item.label : "";
                    const matchesSearch =
                      (item.type || label || "")
                        .toLowerCase()
                      ...
                      <div
                        ...
                        onClick={() => {
                          if (item.category === "INCIDENT")
                            ...
                            openRecordWorkspace(item.entityType, item.entityId);
                        }}
                          ...
                          >
                            ...
                            >
                              ...
                              <div
                                className={`${isHighObstruction ? "text-[12px]" : "text-[11px]"} font-black text-white uppercase`}
                              >
                                {active360Data?.load?.status || "In Transit"}
                              </div>
                            </div>
                            <div
                              className={`${isHighObstruction ? "p-3" : "p-4"} bg-slate-900 border border-white/5 rounded-2xl`}
